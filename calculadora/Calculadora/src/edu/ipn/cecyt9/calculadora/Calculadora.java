...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(500, 500);
		setTitle("Calculadora Simple Cortés Balbuena Jorge 5IM9");
		...
		for (int n = 9; n >= 0; n--) {
			nuevoBotonNumerico("" + n);
                        ...
                        nuevoBotonNumerico("e");
                        nuevoBotonNumerico("π");
                }
		nuevoBotonNumerico(".");
		...
		if (pantalla.getText().equals("0") || nuevaOperacion) {
			...
			pantalla.setText(pantalla.getText() + digito);
                ...
                if(pantalla.getText().equals("π")){
                        pantalla.setText(Math.PI + digito);
                }else
                if(pantalla.getText().equals("e")){
                        pantalla.setText(Math.E+ digito);
                }
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                ...
                else if(operacion.equals("Loglp")){
                    resultado=Math.log1p(new Double(pantalla.getText()));
                }
